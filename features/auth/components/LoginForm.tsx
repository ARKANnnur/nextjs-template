    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 p-6 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl shadow-sm">
      ...
      <div className="mt-2 text-center">
        <p className="text-[10px] text-zinc-400">
          Uji coba dengan: <code className="bg-zinc-100 dark:bg-zinc-800 px-1 py-0.5 rounded font-mono">dev@antigravity.ai</code> dan pass: <code className="bg-zinc-100 dark:bg-zinc-800 px-1 py-0.5 rounded font-mono">dev123</code>
        </p>
      </div>
    </form>
  );
